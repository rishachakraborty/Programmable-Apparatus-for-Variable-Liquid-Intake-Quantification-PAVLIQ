...
class CalibrationPanel(QGroupBox):
    ...
    def __init__(self, calibration: CalibrationSet, get_link, on_change=None):
        ...
        pg_.addWidget(QLabel(
            "<i>Used when the liquid at a spout changes. Aspirate has to "
            "exceed the dead volume of the tip plus tubing, or the old "
            "solution is still in the line when the animal licks.</i>"),
            0, 0, 1, 6)
        ...
        pg_.addWidget(self.parallel, 2, 0, 1, 4)
        v.addWidget(purge)
